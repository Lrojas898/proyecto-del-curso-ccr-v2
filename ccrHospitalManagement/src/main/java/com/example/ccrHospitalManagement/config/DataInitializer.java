...
public CommandLineRunner initData() {
    return args -> {
        ...
        createUserIfNotExists(
            "admin-id", "admin", "123456", "admin@hospital.com", 
            "Admin", "Principal", "Hombre", eps1, pm1, "Administración", "admin"
        );

        // --- DOCTORES ---
        createUserIfNotExists(
            "doctor1-id", "doctor1", "123456", "doc1@hospital.com",
            "Carlos", "Médico", "Hombre", eps1, pm2, "Medicina Interna", "doctor"
        );
        createUserIfNotExists(
            "doctor2-id", "doctor2", "123456", "doc2@hospital.com",
            "Luisa", "Médica", "Mujer", eps2, pm1, "Pediatría", "doctor"
        );
        createUserIfNotExists(
            "doctor3-id", "doctor3", "123456", "doc3@hospital.com",
            "Marco", "Salud", "Hombre", eps1, pm1, "Cardiología", "doctor"
        );

        // --- PACIENTES ---
        createUserIfNotExists(
            "paciente1-id", "paciente1", "123456", "paciente1@gmail.com",
            "Laura", "Pérez", "Mujer", eps2, pm1, null, "paciente"
        );
        createUserIfNotExists(
            "paciente2-id", "paciente2", "123456", "paciente2@gmail.com",
            "Pedro", "Ramírez", "Hombre", eps1, pm2, null, "paciente"
        );
        createUserIfNotExists(
            "paciente3-id", "paciente3", "123456", "paciente3@gmail.com",
            "Lucía", "Fernández", "Mujer", eps2, pm2, null, "paciente"
        );

        // --- TECNICOS ---
        createUserIfNotExists(
            "tecnico1-id", "tecnico1", "123456", "tecnico1@gmail.com",
            "Ana", "López", "Mujer", eps1, pm2, "Laboratorio", "técnico de laboratorio"
        );
        createUserIfNotExists(
            "tecnico2-id", "tecnico2", "123456", "tecnico2@gmail.com",
            "Miguel", "Torres", "Hombre", eps2, pm1, "Radiología", "técnico de laboratorio"
        );
        createUserIfNotExists(
            "tecnico3-id", "tecnico3", "123456", "tecnico3@gmail.com",
