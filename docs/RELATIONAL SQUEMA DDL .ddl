...
ALTER TABLE ATTENTION_EPISODE 
    ADD CONSTRAINT ATTENTION_EPISODE__UN UNIQUE ( USER_id , CLINICAL_HISTORY_id ) ;
...
CREATE TABLE EXAM_RESULT_USER 
    ( 
     EXAM_RESULT_id VARCHAR2 (50)  NOT NULL , 
     USER_id        VARCHAR2 (30)  NOT NULL 
    ) 
;

ALTER TABLE EXAM_RESULT_USER 
    ADD CONSTRAINT EXAM_RESULT_USER_PK PRIMARY KEY ( EXAM_RESULT_id, USER_id ) ;

ALTER TABLE EXAM_RESULT_USER 
    ADD CONSTRAINT EXAM_RESULT_USER__UN UNIQUE ( EXAM_RESULT_id , USER_id ) ;
...
ALTER TABLE USER_APPOINTMENT 
    ADD CONSTRAINT USER_APPOINTMENT_PK PRIMARY KEY ( APPOINTMENT_Id, USER_id ) ;

ALTER TABLE USER_APPOINTMENT 
    ADD CONSTRAINT USER_APPOINTMENT__UN UNIQUE ( APPOINTMENT_Id , USER_id ) ;
...
--  ERROR: FK name length exceeds maximum allowed length(30) 
ALTER TABLE EXAM_RESULT_USER 
    ADD CONSTRAINT EXAM_RESULT_USER_EXAM_RESULT_FK FOREIGN KEY 
    ( 
     EXAM_RESULT_id
    ) 
...
ALTER TABLE EXAM_RESULT_USER 
    ADD CONSTRAINT EXAM_RESULT_USER_USER_FK FOREIGN KEY 
    ( 
     USER_id
    ) 
    REFERENCES "USER" 
...
--  ERROR: FK name length exceeds maximum allowed length(30) 
ALTER TABLE USER_APPOINTMENT 
    ADD CONSTRAINT USER_APPOINTMENT_APPOINTMENT_FK FOREIGN KEY 
    ( 
     APPOINTMENT_Id
    ) 
...
ALTER TABLE USER_APPOINTMENT 
    ADD CONSTRAINT USER_APPOINTMENT_USER_FK FOREIGN KEY 
    ( 
     USER_id
    ) 
    REFERENCES "USER" 
